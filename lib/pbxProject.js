...
pbxProject.prototype.pbxGroupByUuid = function(uuid) {
  return this.hash.project.objects['PBXGroup'][uuid]
}
...
pbxProject.prototype.addTarget = function(name, type, subfolder) {
    ...
    if (targetType === 'app_extension' || targetType == 'app_extension_messages') {
...
function pbxCopyFilesBuildPhaseObj(obj, folderType, subfolderPath, phaseName){
    ...
    var DESTINATION_BY_TARGETTYPE = {
        ...
        app_extension_messages: 'plugins',
        bundle: 'wrapper',
...
function filetypeForProducttype (productType) {
    ...
    FILETYPE_BY_PRODUCTTYPE = {
            ...
            'com.apple.product-type.app-extension.messages': '"wrapper.app-extension"',
